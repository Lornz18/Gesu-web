...
export default function SchoolHomepage() {
  ...
  const highlights = [
    ...
    },
    {
      ...
      description: "100+ certified teachers with advanced degrees and international experience"
    },
    {
      icon: <BookOpen className="w-8 h-8" />,
      title: "Modern Curriculum",
      description: "STEM-focused programs with AI, robotics, and digital literacy integration"
    }
  ];
            ...
            <div className={`space-y-8 transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Join thousands of students worldwide in our cutting-edge educational environment. 
                  Experience personalized learning, innovative technology, and exceptional mentorship.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button className="cursor-pointer border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl hover:border-primary hover:text-primary transition-all duration-300 flex items-center justify-center">
              ...
              <div className="flex items-center space-x-8 pt-4">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center">
                    <div className="text-2xl font-bold text-primary/50">{stat.number}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {highlights.map((highlight, index) => (
              <div key={index} className="group p-8 bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
      ...
      <section className="py-20 bg-primary/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Stay updated with our latest news and events</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-6">
            {announcements.map((announcement, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group hover:-translate-y-1">
                {announcement.urgent && (
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-primary font-medium text-sm">{announcement.date}</span>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Hear from our students, parents, and partners</p>
          </div>
          
          <div className="relative">
            <div className="bg-primary/80 rounded-3xl p-8 text-white text-center">
              <div className="flex justify-center mb-4">
                {[...Array(testimonialSlides[currentSlide].rating)].map((_, i) => (
              ...
              <div>
                ...
                <div className="text-blue-200">{testimonialSlides[currentSlide].role}</div>
              </div>
            </div>
      ...
      <section className="py-20 bg-primary/10 text-black/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90">
            Join our global community of learners and unlock your potential with personalized education, 
            cutting-edge technology, and world-class mentorship.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="font-medium">123 Education Blvd, Learning City</span>
            </div>
          </div>
        </div>
      </section>
