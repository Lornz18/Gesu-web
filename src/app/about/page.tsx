    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 data-aos="fade-up" className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6">
            About Our Institution
          </h1>
          <p data-aos="fade-up" className="text-xl text-foreground/80 leading-relaxed max-w-3xl mx-auto">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-primary/5">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <h2 data-aos="fade-up" className="text-3xl font-bold text-foreground mb-4">Our Mission</h2>
            <div data-aos="fade-up" className="w-24 h-1 bg-primary mx-auto"></div>
          </div>
          <div className="bg-background rounded-lg p-8 sm:p-12 shadow-sm border border-primary/10">
            <p data-aos="fade-up" className="text-lg text-foreground/90 leading-relaxed text-center">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => {
              ...
              return (
                <div data-aos='fade-up' data-aos-duration={index * 500} key={index} className="text-center">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-secondary/5">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 data-aos='fade-up' className="text-3xl font-bold text-foreground mb-6">Our Heritage</h2>
              <div data-aos='fade-up' className="space-y-6 text-foreground/80">
            ...
            <div className="lg:order-first">
              <div className="bg-background rounded-lg p-8 border border-secondary/20 shadow-sm">
                <h3 data-aos='fade-up' className="text-xl font-semibold text-foreground mb-4">Key Milestones</h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 data-aos='fade-up' className="text-3xl font-bold text-foreground mb-4">Our Core Values</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-foreground text-background">
        <div className="max-w-4xl mx-auto text-center">
          <h2 data-aos='fade-up' className="text-3xl font-bold mb-6">Our Vision</h2>
          <p data-aos='fade-up' className="text-xl leading-relaxed opacity-90">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-background border border-primary/10 rounded-lg p-8 sm:p-12 shadow-sm">
            <div className="text-center mb-8">
              <h2 data-aos='fade-up' className="text-2xl font-bold text-foreground mb-2">Message from Leadership</h2>
              <div className="w-16 h-1 bg-secondary mx-auto"></div>
            </div>
            <blockquote data-aos='fade-up' className="text-lg text-foreground/90 leading-relaxed text-center italic">
